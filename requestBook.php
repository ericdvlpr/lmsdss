	               ...
	               <section class="content">
			                  	 <div class="box box-default">
						            <div class="box-header with-border">
						            	 <h3 class="box-title">Refer Material</h3>
						            </div>
						            <div class="box-body">
						            	<div  class="table-responsive">
											...
											Refer Material</button>
			                              	</div>
											<br />
											<br />
											<table class="table table-bordered table-striped" id='request_faculty'>  
		    					                <thead>
			    					                <tr>  
		    					                ...
		    					                <tbody id="request_faculty_table"></tbody> 
							                  </table> 
			                         	</div>
						            </div>
						        </div>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Refer Material</h4>
		      </div>
